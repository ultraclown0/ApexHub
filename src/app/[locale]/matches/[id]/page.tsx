...
const MEDAL: Record<number, string> = {
  ...
  2: "bg-slate-500 text-slate-50",
  3: "bg-amber-800 text-amber-50",
};
            ...
            <section>
              ...
              <div>
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className="sticky left-0 z-20 w-10 min-w-10 max-w-10 bg-table-header">
                        {t("table.place")}
                      </TableHead>
                      <TableHead className="sticky left-10 z-20 w-40 min-w-40 max-w-40 bg-table-header">
                        {t("table.team")}
                      </TableHead>
                      <TableHead className="sticky left-[200px] z-20 w-16 min-w-16 max-w-16 bg-table-header text-center">
                        {t("table.kills")}
                      </TableHead>
                      <TableHead className="sticky left-[264px] z-20 w-16 min-w-16 max-w-16 bg-table-header text-center shadow-[inset_-1px_0_0_0_var(--border)]">
                        {t("table.points")}
                      </TableHead>
                      {gameNumbers.map((n) => (
